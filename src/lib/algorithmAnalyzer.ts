    ...
    const defaultAlgorithms: SocialMediaAlgorithm[] = [
      {
        ...
        name: 'TikTok',
        platform: 'tiktok',
        logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/TikTok_logo.svg/512px-TikTok_logo.svg.png',
        primaryColor: '#000000',
      ...
      },
      {
        ...
        name: 'Instagram',
        platform: 'instagram',
        logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Instagram_logo_2022.svg/512px-Instagram_logo_2022.svg.png',
        primaryColor: '#E4405F',
